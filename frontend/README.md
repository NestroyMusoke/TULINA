...
The Vite/React frontend is a responsive, installable district medicine coordination app. It reads live Phase 2 state from the FastAPI domain service; no transfer outcome is embedded in a component.
